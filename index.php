<?php 
$page_title = "Wandering | Bloggers";
$url_style1 = ' style="color: red;"';
include('config.php');
...
<div class="container">
    ...
    <h1> Blog Posts</h1>
    <a href="add_blog.php?returnURL=index.php" name="add" class="btn blog-btn <?php echo $new_btn_vis ?>">NEW<i class="fas fa-plus"></i></a>
    ...
    <?php
        ...
        $blogs = getBlogsByLimit($order_by, $start, $display );
        ...
        foreach($blogs as $blog){
            ...
            echo '<br/>';
            echo '<a href ="delete_blog.php?delete-blogId='.$blog_id.'&returnURL=index.php" class="btn sm-btn">Yes</a>';
            ...
            //Edit blog button
            echo '<span class="edit-blog"><a href ="edit_blog.php?edit-blogId='.$blog_id.'&s='.$start.'&p='.$pages.'&returnURL=index.php'.'&orderBy='.$sort.'">
           ...
           //*****************************Form for blog rating*****************************//
            ...
            echo '<strong><p class="'.$rating_lbl_vis.'">';
            echo 'Click a star to add or update a rating <br> Click the first star to delete a rating</p></strong>';
            ...
            echo '<br><div class="avg-label" id="rating-box">Average Rating ('.$blog_avg.')</div>';
            echo '<div class="status-confirm hide" id="status-confirm-rating'.$blog_id.'"></div>';
            echo '</form>';
        ...
        if(isset($_SESSION['message']) && isset($_SESSION['status-confirm-rating'])){
            ...
            echo '<script type="text/javascript"> timedMsgById("'.$_SESSION['message'].'", "'.$status_confirm_id.'");</script>';
            //echo '<script type="text/javascript"> timedMsgById("'.$_SESSION['message'].'", "status-confirm-rating");</script>';
            unset($_SESSION['message']);
